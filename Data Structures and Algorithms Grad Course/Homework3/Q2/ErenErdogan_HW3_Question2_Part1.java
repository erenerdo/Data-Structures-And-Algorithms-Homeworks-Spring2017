...
public class ErenErdogan_HW3_Question2_Part1 {
    ...
    public static void main(String[] args) {
        ...
        while(cont) {
            ...
            System.out.println("Quick Sort with median-of-3 took " + time + " seconds on an array of size " + size);
            ...
            System.out.println("Top Down Mergesort took " + time + " seconds on an array of size " + size);
